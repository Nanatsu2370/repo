...
tl_admin_users = ['Yama_Tsukami','FriendXfriendss','user3'] #Poner aqui los user con acceso permanente
godlist = ['Yama_Tsukami','FriendXfriendss','admin3'] #Poner aqui los admin 
